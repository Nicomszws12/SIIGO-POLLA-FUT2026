/* ============================================================
   ...
   ============================================================ */
const CACHE_NAME = 'polla-cache-v9'; // Incrementamos la versión para forzar la actualización
const APP_SHELL = [
  '/',
  'index.html',
  'app.html',
  ...
  'cuentas.html',
  'reglas.html',
  'admin.html', // Eliminado 'sala-admin.html' que no existe
  'css/estilos.css',
  'js/config.js',
  'js/fixture.js',
  'js/utils.js',
  ...
  'icons/icon-192.png',
  'icons/icon-512.png',
  'sounds/gol.mp3' // Nuevo sonido de gol
];
